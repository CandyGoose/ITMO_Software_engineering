'''
Создайте программу «Список» для пользовательского ввода одномерного списка, состоящего из чисел
(положительных/отрицательных, целых/дробных). Позволяйте пользователю вводить числа до тех пор, пока он не введет «Q».
