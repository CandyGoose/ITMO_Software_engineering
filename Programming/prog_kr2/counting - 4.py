'''
Создайте программу для определения водящего считалкой. Чтобы выбрать водящего в игре, n ребят встают в круг и, начав
отсчет от первого, удаляют каждого k-ого, смыкая круг после каждого удаления. Определить имя (или номер) последнего человека.
'''
