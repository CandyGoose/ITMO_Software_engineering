'''
Напишите программу «Новый год» (для текущего года), которая вводит с клавиатуры номер месяца и день, и определяет,
сколько дней осталось до Нового года. Учесть ввод корректного месяца/дня.
'''
