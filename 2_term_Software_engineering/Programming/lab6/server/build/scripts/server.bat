...
set CLASSPATH=%APP_HOME%\lib\server.jar;%APP_HOME%\lib\common.jar;%APP_HOME%\lib\xstream-1.4.20.jar;%APP_HOME%\lib\mxparser-1.2.2.jar;%APP_HOME%\lib\xmlpull-1.1.3.1.jar
